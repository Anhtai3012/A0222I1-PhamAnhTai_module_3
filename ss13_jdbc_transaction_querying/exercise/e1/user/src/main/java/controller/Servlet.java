...
//        SearchName(request,response);
    ...
    private void SearchName(HttpServletRequest request, HttpServletResponse response) {
       ...
       // List<User> searchName = userDAO.searchName(sName);
        List<User> searchName = this.userDAO.searchName2(sName);
...
//        userDAO.updateUser(user);
        this.userDAO.procedureUpdateUser(user);
//        RequestDispatcher requestDispatcher =request.getRequestDispatcher("/view/list.jsp");
...
//        List<User> sortName = userDAO.SortName();
    ...
    private void deleteUser(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {
        ...
        this.userDAO.procedureDeleteUsers(id);
    ...
    private void listUser(HttpServletRequest request, HttpServletResponse response) {
        List<User> userList  = userDAO.procedureSelectAll();
        //List<User> userList = userDAO.selectAllUser();
        request.setAttribute("userList",userList);
        RequestDispatcher requestDispatcher = request.getRequestDispatcher("view/list.jsp");
        try {
