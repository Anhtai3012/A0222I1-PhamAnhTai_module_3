...
public class Utils {
    private static final String URL ="jdbc:mysql://localhost:3306/case_study_m3"; // sửa lại tên của csdl
...
//        return connection;
    ...
    public static Contract createContract(ResultSet resultSet) throws SQLException {
        int id = resultSet.getInt("id");
        String start_day = String.valueOf(resultSet.getTimestamp("start_date"));
        String end_day = String.valueOf(resultSet.getTimestamp("end_date"));
        double deposit = resultSet.getDouble("deposit");
        int employee_id = Integer.parseInt(resultSet.getString("employee_id"));
        int customer_id = Integer.parseInt(resultSet.getString("customer_id"));
        int service_id = Integer.parseInt(resultSet.getString("service_id"));
    ...
    public static Contract createContractName(ResultSet resultSet) throws SQLException {
        ...
        String end_day = String.valueOf(resultSet.getTimestamp("end_date"));
        double deposit = resultSet.getDouble("deposit");
        int employee_id = Integer.parseInt(resultSet.getString("en"));
        int customer_id = Integer.parseInt(resultSet.getString("cn"));
        int service_id = Integer.parseInt(resultSet.getString("sn"));
        double total_money = resultSet.getDouble("total_money");
        return new Contract(id, start_day, end_day, deposit, employee_id, customer_id, service_id, total_money);
    }
